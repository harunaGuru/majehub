...
import { ChevronRight, PlusIcon, Search, SignalHigh } from 'lucide-react';
...
const restoreEventProduct = async (id: string) => {
...
const Page = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['Events', page, limit, searchParam],
    queryFn: () =>
      getAllEvents(page, limit, isServerSearch ? searchParam : undefined),
  });
